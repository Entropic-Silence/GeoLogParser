...
def main() -> None:
    ...
    lines.extend([
        ...
        "- Paper II: `EXPERIMENTING`. Five mutually disjoint California evaluations show unselective F1 gains with FCR 0.084–0.210, while the frozen addition-only policy accepted 43/43 and 39/39 correct additions on v004/v005. On BGS v001, v018 reached boundary precision/recall/F1 0.4940/0.2262/0.3103 and interval F1 0.1116 at ±0.05 m. v021 multi-column events reached interval F1 0.1213. The v022 learned semantic-column gate retained six columns/page and reached boundary F1 0.3216 and interval F1 0.1475, with CNER 0.3390; it remains below the 0.15 release gate. A pairwise interval ranker was rejected at interval F1 0.0445. The independent NativeMM branch was closed `NO_GO`: its best boundary F1 was 0.0789 and best interval F1 0.0312. BGS v002 remains unspent. External confirmation remains `NOT COMPLETED`.",

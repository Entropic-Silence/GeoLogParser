...
def main() -> None:
    ...
    lines.extend([
        ...
        "- Paper II: `EXPERIMENTING`. Five mutually disjoint California evaluations show unselective F1 gains with FCR 0.084–0.210, while the frozen addition-only policy accepted 43/43 and 39/39 correct additions on v004/v005. On BGS v001, corrected plural-header and bidirectional scale parsing restored 34/34 page layouts and 97/367 exact field-ROI-visible boundaries. The v018 source-disjoint mixed-page semantic-role experts reached boundary precision/recall/F1 0.4940/0.2262/0.3103 and interval F1 0.1116 at ±0.05 m; calibrated candidate ECE was 0.0352. Its sequence-level selective operating point accepted 43 boundaries with precision 0.9302, coverage 0.1172, and CNER 0.0698. The independent NativeMM branch completed generative SFT plus dense pixel/visual/fused ablations and was closed `NO_GO`: the best source-group-disjoint NativeMM boundary F1 was 0.0789 and best interval F1 was 0.0312. BGS v002 remains unspent. External confirmation remains `NOT COMPLETED`.",

...
def main() -> None:
    ...
    lines.extend([
        ...
        "- Paper II: `RESULTS_AVAILABLE` for five mutually disjoint California evaluations: unselective constraints raised F1 from 0.390 to 0.514 (FCR 0.165), 0.450 to 0.564 (FCR 0.177), 0.383 to 0.470 (FCR 0.210), 0.428 to 0.566 (FCR 0.121), and independent v005 0.389 to 0.530 (FCR 0.084). The candidate-level policy accepted 43/43 correct additions on v004 and 39/39 on v005, worsened no document in either set, and raised F1 to 0.454 and 0.411 respectively. Broader multimodal attribution and one-module real ablations remain `NOT COMPLETED`.",

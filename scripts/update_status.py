...
def main() -> None:
    ...
    lines.extend([
        ...
        "- Paper III: `MANUSCRIPT_IN_PROGRESS` with a real structured-source controlled comparison, 35-document first/four-boundary surfaces, a real three-layer risk-aware volume diagnostic, 540 seeded repetitions across six error classes, an external 88-document page-coordinate evaluation, and a partial 35-document page-coordinate surface workflow. Risk-aware abstention reduced relative volume error from 0.1389 (raw) to 0.0824 and mean thickness MAE from 45.952 m to 34.808 m while accepting 15/35 documents and eliminating negative-thickness layers. Page-derived collar extraction, validated geological interpretation, and timed human study remain `NOT COMPLETED`.",
        "",
        "## Boundary",
        "",

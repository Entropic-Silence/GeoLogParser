...
Git commit: `910911505b8f51eff8f640fcc89fc2ed0ca050d5`
...
- Paper III: `RESULTS_AVAILABLE` for a real structured-source controlled spatial comparison, a controlled Synthetic downstream comparison, and 35-document image-derived first- and four-boundary surface diagnostics using authoritative spatial metadata; complete image-derived spatial metadata extraction, stratigraphic modelling, and timed human study `NOT COMPLETED`.

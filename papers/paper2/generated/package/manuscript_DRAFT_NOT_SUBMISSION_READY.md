...
We study whether geological and numerical constraints can improve borehole-log extraction without silent rule-based overwriting. The method separates positioned OCR evidence, sequence candidates, depth monotonicity, boundary continuity, column stability, targeted rereading, ranking, confidence, and abstention. Its principal real evidence uses four mutually record-disjoint California evaluations with 697, 1,770, 1,788, and 1,944 published manually transcribed intervals. A deterministic sequence ranker increased interval F1 from 0.390 to 0.514 on v001, 0.450 to 0.564 on v002, 0.383 to 0.470 on v003, and 0.428 to 0.566 on v004. FCR was 0.165, 0.177, 0.210, and 0.121. A candidate-level addition-only policy was frozen using v001/v002 and before v004 acquisition; it retained raw intervals, accepted only non-overlapping candidates with node score ≥2.999, raised v004 F1 to 0.454, accepted 43 additions, produced 0 observed false corrections, and worsened no document. The exact two-sided 95% upper bound for zero errors over 43 accepted actions is 0.082. Complementary evidence includes a 35-document Swissgeol held-out test where rereading raised F1 from 0.857 to 0.921 with FCR 0/4, a separate 20-document negative validation, and a 31-document BGS consensus/abstention study. Constraints improve recovery, but their safety depends on candidate-level abstention rather than sequence expansion alone. <!-- evidence:p2.california_constraint_sequence --> <!-- evidence:p2.california_external_constraint_sequence --> <!-- evidence:p2.california_prospective_constraint_sequence --> <!-- evidence:p2.california_prospective_selective --> <!-- evidence:p2.california_v004_candidate_risk -->
...
We provide an implemented constraint-guided extraction architecture and evaluate both recovery and harm. Across four mutually disjoint California sets totaling 350 reports and 6,199 published manually transcribed intervals, frozen sequence ranking raised F1 by 0.124, 0.114, 0.087, and prospectively 0.138, but FCR was 0.165, 0.177, 0.210, and 0.121. The candidate-level addition-only policy, frozen before v004 acquisition, retained a smaller F1 gain of 0.026 while observing zero false corrections over 43 accepted actions and no worsened document; its exact two-sided 95% upper error bound was 0.082. A separate Swissgeol test improved from F1 0.857 to 0.921 with FCR 0/4, whereas another frozen application produced no correction. The evidence supports geology-aware sequence reasoning as a recovery mechanism and candidate-level abstention as a promising safety frontier, but not unconditional automatic repair. Reliable deployment requires more independent action counts, calibrated candidate risk, and stronger field-localized evidence. <!-- evidence:p2.california_prospective_constraint_sequence --> <!-- evidence:p2.california_prospective_selective --> <!-- evidence:p2.california_v004_candidate_risk --> <!-- evidence:p2.california_v004_candidate_risk_analysis -->

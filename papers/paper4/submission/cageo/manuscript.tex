...
\item Independent evidence reaches 0.993 precision at 24.4\% proposal coverage.
\item Only 4\% of held-out documents qualify for complete automatic acceptance.
\item Abstention changes spatial support and can reverse apparent improvement.
\end{itemize}
...
\begin{figure}
\centering
\includegraphics[width=0.94\textwidth,keepaspectratio,alt={Figure 1. Provenance-grounded assurance framework.}]{figures/Figure_1.pdf}
...
\bottomrule\noalign{}
\endlastfoot
Zhang et al.~(2020) \citep{zhang2020boreholeimages} & Borehole-log images & OCR/deep model & Not reported & Not reported & Not reported & Not reported & Not reported \\
Han and Suh (2024) \citep{han2024boreholeocr} & Abandoned-mine logs & OCR/deep model & Not reported & Page extraction, not field trace & Not reported & Structured target, not admission & Not reported \\
Amini et al.~(2023) \citep{amini2023boreholepdf} & Government PDF logs & OCR/PDF workflow & Multiple PDF sources & PDF selection and capture & Not reported & Not reported & Not reported \\
Ma et al.~(2024) \citep{ma2024historicalwell} & Historical well records & Large language model & Not reported & Record extraction, not bbox gate & Not reported & Not reported & Not reported \\
Geifman and El-Yaniv (2017) \citep{geifman2017selective} & General classification & Neural classifier & Not applicable & Model confidence & Reject option & Coverage/risk, not documents & Not reported \\
Hendrickx et al.~(2024) \citep{hendrickx2024reject} & Reject-option survey & Multiple ML settings & Review of settings & Not a source-provenance workflow & Selective risk & Not document completeness & Not reported \\
Buneman et al.~(2001) \citep{buneman2001provenance} & Database provenance & Not an extraction model & Not applicable & Provenance semantics & Not an acceptance experiment & Not reported & Not reported \\
Lark et al.~(2014) \citep{lark2014crosssection} & Geological cross-sections & Geoscientific modelling & Borehole uncertainty & Input uncertainty & Not an extraction gate & Not reported & Support/model uncertainty \\
...
\begin{figure}
\centering
\includegraphics[width=0.94\textwidth,keepaspectratio,alt={Figure 2. Modern VLM reliability across California cohorts and source shift.}]{figures/Figure_2.pdf}
...
\begin{figure}
\centering
\includegraphics[width=0.94\textwidth,keepaspectratio,alt={Figure 3. Selective assurance viewed simultaneously as precision, proposal coverage, complete-document automation, and a held-out v003 evidence funnel. Numeric anchors are reported separately as endpoint-field coverage (3,099/3,666) and as both-endpoint interval coverage (1,450/1,833); only semantically owned intervals are accepted.}]{figures/Figure_3.pdf}
...
\begin{figure}
\centering
\includegraphics[width=0.94\textwidth,keepaspectratio,alt={Figure 4. Full-support versus matched-support downstream consequence of selective acceptance.}]{figures/Figure_4.pdf}

...
- `submission_bundle/`: generated, hash-manifested manuscript-facing files for
  individual portal upload; it excludes uncleared source PDFs and page assets.
...
file list and checksum record. The package remains labelled
`SUBMISSION_READY_CANDIDATE` until external rights, linkage, authorship, and
journal-format checks are completed.

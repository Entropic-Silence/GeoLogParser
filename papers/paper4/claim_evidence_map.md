...
| C4-09 | The single five-page BGS v003 record produces no accepted output | `p2.bgs_v003_v028_external_failure` | External source-shift diagnostic | `publication_evidence/result_core/results/2026-08-16/P2_BGS_V028_ROUTED_EXTERNAL_V003_FINAL/metrics.json` |

...
from .openai_responses import OpenAIResponsesVLMAdapter
...
__all__ = [
    "AnthropicMessagesVLMAdapter", "OpenAICompatibleVLMAdapter", "OpenAIResponsesVLMAdapter", "Qwen3VLTransformersAdapter", "VLMAdapter", "VLMGeneration",
